...
// 18 20
// 15 18
//----------Первое решение (с ровными матрицами)
Console.Clear();
...
//--------------Второе решение (с кривыми матрицами)-----------------------

Console.WriteLine("Вводим размеры матриц и диапазон случайных значений:");
Console.WriteLine("Вводим кол-во строчек матрицы А:");
int m = Convert.ToInt32(Console.ReadLine());
Console.WriteLine("Вводим кол-во столбиков матрицы А (и строк матрицы Б):");
int n = Convert.ToInt32(Console.ReadLine());
Console.WriteLine("Вводим кол-во столбиков матрицы Б:");
