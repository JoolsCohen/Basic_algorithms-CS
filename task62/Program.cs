...
//какая то фигня, все заполняется 00

int n = 4;
int[,] array = new int[n, n];

int beginI = 0; // При заполнении массива будем очерчивать прямоугольники, каждый из которых на единицу меньше с каждой стороны.
